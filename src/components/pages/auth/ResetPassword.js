    ...
    <>
        <Grid container justifyContent='center'>
            <Grid item sm={6} xs={12}>
                ...
                <Box component='form' noValidate sx={{ p:4 }} id='password-reset-form' onSubmit={handleSubmit}>
                    ...
                    <Box textAlign='center'>
                        <Button type='submit' variant='contained' sx={{ my: 2, py: 1, px: 4}} color='secondary'>Save</Button>
                    </Box>
